...
- **`nextjs_frontend`**: Next.js Frontend Application (Port 3001). User interface for browsing schedules. See [detailed frontend documentation](./nextjs_frontend/README.md).
